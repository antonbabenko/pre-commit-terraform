...
* Fix regression from [v1.90.0](https://github.com/antonbabenko/pre-commit-terraform/releases/v1.90.0) so hook start failing once again if terraform/tofu binary not found
