...
Read `.github/PULL_REQUEST_TEMPLATE.md` — fill in its sections (checkboxes, testing). For `### Description of your changes`, use this structure exactly — no other AI-generated content inside it:
