...
Read `.github/PULL_REQUEST_TEMPLATE.md` — fill in its sections (checkboxes, testing). For any section not explicitly described below, prepend `<sub>This section was generated by AI.</sub>` to its content.
